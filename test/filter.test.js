...
describe('filter()', () => {
  ...
  it('filters an object to only non-numeric values', () => {
    ...
    const stringVal = _.filter(characterAttributes, (value) => isNaN(value));
    expect(stringVal).toEqual(['Thokul Mongothsbeard', 'Lord Thokul Mongothsbeard the Arcane', 'human', 'druid']);
  });
});